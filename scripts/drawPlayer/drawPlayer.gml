...
function drawPlayer() {
	...
	drawSelf();
	draw_sprite_ext(primary, image_index, round(x), round(y), image_xscale, image_yscale, image_angle, global.primaryCol[playerID], image_alpha);
	draw_sprite_ext(secondary, image_index, round(x), round(y), image_xscale, image_yscale, image_angle, global.secondaryCol[playerID], image_alpha);
	draw_sprite_ext(outline, image_index, round(x), round(y), image_xscale, image_yscale, image_angle, global.outlineCol[playerID], image_alpha);
*/
	drawSelf3Colors(global.primaryCol[playerID], global.secondaryCol[playerID], global.outlineCol[playerID]);
