function playerSwitchSections() {
	...
	if x > sectionRight-6 && place_meeting(x-global.xspeed[playerID]+6, y, objSectionArrowRight) //Right
	&& collision_rectangle(sectionRight+1, bbox_top, sectionRight+2, bbox_bottom, objSolid, false, false) < 0
	{
	    //if (playerID != 1) {instance_destroy();}
	...
	else if x < sectionLeft+6 && place_meeting(x-global.xspeed[playerID]-6, y, objSectionArrowLeft) //Left
	...
	else if sprite_get_ycenter() > sectionBottom-6 && place_meeting(x, sprite_get_ycenter()-global.yspeed[playerID]+6, objSectionArrowDown) //Down
	...
	else if sprite_get_ycenter() < sectionTop+6 && place_meeting(x, sprite_get_ycenter()-global.yspeed[playerID]-6, objSectionArrowUp) //Up
