...
function drawSelf3Colors(argument0, argument1, argument2) {
	...
	shader_set_uniform_f(shader_params, colour_get_red(make_color_rgb(0,112,236)) / 255.0, colour_get_green(make_color_rgb(0,112,236)) / 255.0, colour_get_blue(make_color_rgb(0,112,236)) / 255.0, 1.0);
	...
	shader_set_uniform_f(shader_params, colour_get_red(make_color_rgb(0,232,216)) / 255.0, colour_get_green(make_color_rgb(0,232,216)) / 255.0, colour_get_blue(make_color_rgb(0,232,216)) / 255.0, 1.0);
	...
	shader_set_uniform_f(shader_params, colour_get_red(make_color_rgb(0,0,0)) / 255.0, colour_get_green(make_color_rgb(0,0,0)) / 255.0, colour_get_blue(make_color_rgb(0,0,0)) / 255.0, 1.0);
