if room == rmWindman && !instance_exists(objPauseMenu)
{
	draw_set_halign(fa_right);
	draw_set_color(c_white);
	draw_set_font(global.MM3font);
	if /*showCon &&*/ global.player2Active && instance_number(objMegaman) == 1
	{
		draw_text(global.viewX + 256 - 10, global.viewY+2,"SELECT: REVIVE PLAYER");
		/*
